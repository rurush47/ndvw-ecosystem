...
public class TestRabbitController : AnimalController<PreyStates>
{
	// NEW //////////////////
	...
	{
		bool walking = false;
		if (currentState == PreyStates.Goto)
		{
			walking = true;
		}
		if (currentState == PreyStates.DoAction)
		{
			walking = false;
		}
		if (currentState == PreyStates.Flee)
		{
			walking = true;
		}
		if (currentState == PreyStates.Search)
		{
			walking = true;
		}
		RabbitAnimator.SetBool("walking",walking);
